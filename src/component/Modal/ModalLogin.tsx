  ...
  return (
    <div className="container">
      <div className="flex justify-center">
        ...
        >
          <h1 className="text-5xl text-bottomvote font-black text-center mt-16">
            LOGIN
          </h1>
          ...
          <input 
            ...
            name="username"
            id="username"
            className="lg:w-478 px-6 lg:h-70 w-[330px] h-[40px] border-logincolor border-2 rounded-2xl mt-3"
          />
          ...
          <button
            type="submit"
            className="lg:w-478 lg:h-68 w-[330px] h-[40px] bg-bottomvote font-bold lg:text-3xl text-2xl text-white rounded-2xl mt-16"
          >
            SUBMIT
          </button>

          <div className="flex mt-6 mx-auto">
            <p className="lg:text-2xl text-xl text-logincolor italic">
              Belum memiliki akun ?
            </p>
            <p
