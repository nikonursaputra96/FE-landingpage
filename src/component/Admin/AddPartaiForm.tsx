        ...
        <div className='container'>
            ...
            <div className='flex justify-center gap-12'>
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="text" className='w-478 h-[139px] border-logincolor border-2 rounded-2xl mt-3' />
                    <label htmlFor="username" className='text-2xl font-bold text-logincolor mt-5'>Alamat</label>
                    <input type="text" className='w-478 h-[139px] border-logincolor border-2 rounded-2xl mt-3' />
                    <button className='w-478 h-68 bg-bottomvote font-bold text-3xl text-white rounded-2xl mt-10' onClick={() => navigate('/partai')}>SUBMIT</button>
                </div>
            </div>
        </div>
    )
