  ...
  return (
    ...
    <div className='lg:flex lg:justify-center lg:gap-12  '>
        ...
        <div className='flex flex-col'>
            ...
            <input type="text" className='lg:w-478 lg:h-249 w-[330px] h-[150px] border-logincolor border-2 rounded-2xl mt-3' />
            <button className='lg:w-478 lg:h-68 w-[330px] h-[40px] bg-bottomvote font-bold lg:text-3xl text-2xl text-white rounded-2xl mt-10' onClick={() => navigate('/paslon')}>SUBMIT</button>
            </div>
        </div>
    </div>
</div>
