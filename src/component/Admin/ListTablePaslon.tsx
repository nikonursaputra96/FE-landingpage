            ...
            <table className='table-auto border-collapse mt-12 text-sm'>
                <thead>
                    <tr>
                        ...
                        <th className='border px-6 py-3.5 border-gray-600 bg-table'>Image</th>
                        ...
                        <th className='border px-6 py-3.5 border-gray-600 bg-table'>Koalisi</th>
                    </tr>
                </thead>
                ...
                {ListPaslon && ListPaslon.map((listpaslon, index) => {
                    return (
                        <tbody key={index}>
                            <tr>
                                <td className='border px-6 py-3  border-gray-600'>1</td>
                                <td className='border px-6 py-3  border-gray-600' >
                                    <img src={listpaslon.image} className='w-78 h-94' alt="" />
                                </td>
                                <td className='border px-6 py-3  border-gray-600'>{listpaslon.name}</td>
                                <td className='border px-6 py-3  border-gray-600'>
